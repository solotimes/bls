...
"<script type=\"text/javascript\" src=\"http://www.jmeditor.com/jme/script/version.js\"></script>" +
"<script type=\"text/javascript\"> setTimeout(function(){init();},10); </script>");
  var jmeMath = [
    [
      "{/}frac{}{}","^{}/_{}","x^{}","x_{}","x^{}_{}","{/}bar{}","{/}sqrt{}","{/}nthroot{}{}",
      "{/}sum^{}_{n=}","{/}sum","{/}log_{}","{/}ln","{/}int_{}^{}","{/}oint_{}^{}","+","-","{/}times","{/}div"
    ],
    [
...
function init(){
    ...
    //验证版本信息
    // if(JMEditor.versionCode > 0 && JME_TOP_VERSION != null
